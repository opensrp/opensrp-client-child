                    ...
                    case BOTH:
                        ...
                        remoteLocalCursor
                                .addRow(new Object[]{createRemoteLocalCursor.getId(), createRemoteLocalCursor.getRelationalId(),
                                        ...
                                        createRemoteLocalCursor.getMotherFirstName(), createRemoteLocalCursor.getMotherLastName(), createRemoteLocalCursor.getGender(), createRemoteLocalCursor.getDob(), createRemoteLocalCursor.getOpenSrpId()});
                        break;
                    case RIGHT:
                        ...
                        remoteLocalCursor
                                .addRow(new Object[]{localCreateRemoteLocalCursor.getId(), localCreateRemoteLocalCursor.getRelationalId(),
                                        ...
                                        localCreateRemoteLocalCursor.getMotherFirstName(), localCreateRemoteLocalCursor.getMotherLastName(), localCreateRemoteLocalCursor.getGender(), localCreateRemoteLocalCursor.getDob(), localCreateRemoteLocalCursor.getOpenSrpId()});
