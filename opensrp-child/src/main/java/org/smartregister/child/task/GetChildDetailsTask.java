    ...
    protected CommonPersonObjectClient doInBackground(Void... params) {
        ...
        if (!TextUtils.isEmpty(motherBaseEntityId)) {
            ...
            if (rawMotherDetails != null) {
                motherDetails.put("mother_first_name", rawMotherDetails.get("first_name"));
                motherDetails.put("mother_last_name", rawMotherDetails.get("last_name"));
                motherDetails.put("mother_dob", rawMotherDetails.get("dob"));
                motherDetails.put("mother_nrc_number", rawMotherDetails.get("nrc_number"));
            }
        }
