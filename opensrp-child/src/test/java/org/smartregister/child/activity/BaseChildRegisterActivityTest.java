...
public class BaseChildRegisterActivityTest extends BaseUnitTest {
    ...
    public void setUp() {
        ...
        baseChildRegisterActivity = Mockito.spy(Robolectric.buildActivity(TestBaseChildRegisterActivity.class).create().get());
        Mockito.doReturn(context).when(baseChildRegisterActivity).getOpenSRPContext();
        Mockito.doReturn(context).when(baseChildRegisterActivity).context();
    ...
    @Test
    public void testOnActivityResultForBarcodeShouldUpdateAdvancedSearchFormData() {
        HashMap<String, String> advancedSearchFormData = new HashMap<>();

        Whitebox.setInternalState(baseChildRegisterActivity, "presenter", presenter);
        Whitebox.setInternalState(baseChildRegisterActivity, "isAdvancedSearch", true);
