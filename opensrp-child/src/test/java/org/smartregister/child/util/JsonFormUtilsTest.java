...
public class JsonFormUtilsTest {
    ...
    public void testProcessReturnedAdvanceSearchResults() {
        ...
        List<ChildMotherDetailModel> childMotherDetailModels = JsonFormUtils.processReturnedAdvanceSearchResults(response);
        ...
        Assert.assertEquals(firstChild.getColumnValuesFromJson().length, 13);
        Assert.assertEquals(secondChild.getColumnValuesFromJson().length, 13);
