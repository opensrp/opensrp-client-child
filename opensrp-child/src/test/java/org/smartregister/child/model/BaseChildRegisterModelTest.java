...
public class BaseChildRegisterModelTest {
    ...
    private BaseChildRegisterModel baseChildRegisterModel;
    ...
    @Before
    public void setUp() {
        baseChildRegisterModel = new BaseChildRegisterModel();
